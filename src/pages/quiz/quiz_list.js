...
import { filterQuizListData, getAllQuizData, deleteQuizDetailData } from "../../network/quiz_api";
    ...
    return (
        ...
        <div>
            ...
            <section className="bg-gray-50 antialiased mt-10">
                <HeaderWithLink title={"Quiz List"} total={totalCount} searchPlcehoder={"Search by title"} onSearch={handleSearch} displayFilterBtn={true} onFilter={handleFilter} />
