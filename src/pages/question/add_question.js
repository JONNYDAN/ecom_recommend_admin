...
import { getCourseDetailData } from "../../network/course_api";
...
const AddQuestion = () => {
    ...
    const formik = useFormik({
        ...
        validate: (values) => {
            ...
            if (!values.group) {
                errors.group = 'Point is required';
            }
            ...
            <div className="bg-gray-50 h-screen">
                <section className=" mx-auto bg-white shadow-md mt-10">
                    <div className="py-8 px-4 mx-auto">
                        ...
                        {/* <p className="mb-4 text-xl"><b>Course: </b>{courseResult.title}</p> */}
                        <p className="mb-4 text-xl"><b>Quiz: </b>{quizResult.title}</p>
                        <form className="mt-10" onSubmit={formik.handleSubmit}>
                            <div className="grid gap-4 grid-cols-2 pt-2 ">
                                ...
                                <div className="w-full">
                                    ...
                                    <input type="text" name="group" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Mondai" onChange={formik.handleChange}
                                ...
                                <div className="w-full">
                                    <label htmlFor="option_a" className="block mb-2 text-sm font-medium text-gray-900">Option 1</label>
                                ...
                                <div className="w-full">
                                    <label htmlFor="option_b" className="block mb-2 text-sm font-medium text-gray-900">Option 2</label>
                                ...
                                <div className="w-full">
                                    <label htmlFor="option_c" className="block mb-2 text-sm font-medium text-gray-900">Option 3</label>
                                ...
                                <div className="w-full">
                                    <label htmlFor="option_d" className="block mb-2 text-sm font-medium text-gray-900">Option 4</label>
